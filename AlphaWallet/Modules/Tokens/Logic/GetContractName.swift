...
class GetContractName {
    ...
    func getName(for contract: AlphaWallet.Address) -> Promise<String> {
        ...
        return callSmartContract(withServer: server, contract: contract, functionName: functionName, abiString: web3swift.Web3.Utils.erc20ABI, timeout: AlphaConstants.fetchContractDataTimeout).map { nameResult -> String in
